...
{
    // إدارة المستويات الدراسية — شاشة مستقلة. المنطق في ILookupAdminService (فئة "academiclevel").
    [ApiController]
    [Route("api/admin/academic-levels")]
    [Authorize(Policy = "lookups.manage")]
    public class AcademicLevelsController : ControllerBase
    {
        private const string Cat = "academiclevel";
        private readonly ILookupAdminService _svc;
        public AcademicLevelsController(ILookupAdminService svc) => _svc = svc;
