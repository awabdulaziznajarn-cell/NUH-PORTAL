namespace NUH_PORTAL.DTOs.Registration
{
    ...
    public class PledgeRecordDto
    {
        ...
        // ⚠️ رمز التحقّق المطبوع على الوثيقة (NU-XXXX-XXXX-XXXX). بيتحسب لحظة
        //    الطلب لا بيتخزّن - الشرح في Core/PledgeRules.BuildDocCode.
        //    null معناها «اطبع الوثيقة بلا رمز»: تعهّد بلا بصمة، أو مفتاح
        //    التوقيع مش مضبوط في الإعدادات.
        public string? DocCode { get; set; }

        // ⚠️ رقم الطلب الداخلي - الواجهة محتاجاه عشان تسجّل الطباعة وتجيب
        //    تاريخها من الخادم (js/pledge-doc.js). الشاشات اللي بتقرا الكائن ده
        //    كلها شاشات موظفين وبتعرف رقم الطلب أصلًا، فمفيش جديد بيتكشف.
        public int RequestId { get; set; }
    }

    // ========================================================================
    //  نتيجة التحقّق من رمز وثيقة - بتتعرض في صفحة عامة بلا تسجيل دخول.
    //
    //  ⚠️ اللي فيها هو **أقل** ما يكفي للمطابقة: اللي ماسك الورقة ممكن يكون
    //     جهة خارجية، والصفحة مفتوحة لأي حد معاه الرمز. الاسم مقنّع وآخر ٤
    //     أرقام من الرقم الجامعي - نفس قاعدة شاشة تتبّع الطلب. مفيش جوال ولا
    //     هوية ولا عنوان جهاز ولا حالة الطلب.
    // ========================================================================
    public class PledgeVerifyDto
    {
        public string? RequestNumber { get; set; }
        public string? StudentName { get; set; }
        public string? StudentIdTail { get; set; }
        public DateTime AcceptedAt { get; set; }
        public string? PolicyVersion { get; set; }
    ...
    // ========================================================================
    //  مرجع الوثيقة بعد قراءة رمزها - لشاشة «ملف الطالب» وحدها.
    //
    //  ⚠️ ده مش نسخة من PledgeVerifyDto: الأخير بيروح لصفحة عامة فبيانه
    //     مقنّع، وده بيروح لشاشة مقفولة بـ students.investigate فبيدّيها
    //     المفاتيح اللي تفتح بيها الملف كله. كائنان لأن الجمهورين مختلفين،
    //     لا لأن البيانات مختلفة.
    // ========================================================================
    public class PledgeDocRefDto
    {
        public int RequestId { get; set; }
